                ...
                <Dialog as="div" className="relative z-10" onClose={closeModal}>
                    ...
                    <div className="fixed inset-0 overflow-y-auto">
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <Dialog.Panel className="w-full h-79 max-w-sm transform overflow-hidden rounded-3xl py-4 mt-16 mb-0.1  text-left align-middle shadow-xl transition-all bg-gray-50">

                                    <section className="">
                                        <div className="flex flex-col items-center justify-center py-2 mx-auto  lg:py-0">
                                          
                                            <div className="w-full    md:mt-0 sm:max-w-md xl:p-0 ">
                                                <div className="p-1 space-y-2 md:space-y-3 sm:p-4">
