  ...
  return (
    <div className="bg-white sticky top-0 z-50  "  >
          ...
          <div className="fixed inset-0 z-40 flex">
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <Link to={'/login'} className="text-sm font-medium text-gray-900 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    Login
                  </Link>
                </div>

                <div className='space-y-6 border-t border-gray-200 px-4 py-6'>
                <Link to={'/signup'} className="text-sm font-medium text-gray-900 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    SignUp
                  </Link>
                </div>
               ...
               <Link to={'/allproducts'} className="text-sm font-medium text-gray-900 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                ...
                {user?.user?.email === 'rajvir12@gmail.com' ? 
                 <div className="flow-root">
                  ...
                  <div className="flow-root">
                    <Link to={'/'} className="-m-2 block p-2 font-medium text-gray-900 cursor-pointer">
                      <img
                        ...
                        src="https://media.istockphoto.com/id/1296016253/photo/beautiful-indian-woman-wearing-traditional-sari-dress.webp?b=1&s=170667a&w=0&k=20&c=JmvlIWCDhf_cNot1eQO9MZzNeNo4MrIgkIXLu36PjNs="
      ...
      <header className="relative bg-white">
        <p className="flex h-10 items-center justify-center bg-pink-900 px-4 text-sm font-medium text-white sm:px-6 lg:px-8" style={{ backgroundColor: mode === 'dark' ? 'rgb(62 64 66)' : '', color: mode === 'dark' ? 'white' : '', }}>
